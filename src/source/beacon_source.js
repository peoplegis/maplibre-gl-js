...
import type {
    BeaconSourceSpecification
} from '../style-spec/types';

class BeaconSource extends Evented implements Source {
    type: 'beacon';
    id: string;
    minzoom: number;
    maxzoom: number;
    ...
    _loaded: boolean;
    _options: BeaconSourceSpecification;
    _tileJSONRequest: ?Cancelable;

    constructor(id: string, options: BeaconSourceSpecification, dispatcher: Dispatcher, eventedParent: Evented) {
        super();
        this.id = id;
